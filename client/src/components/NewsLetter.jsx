...
const NewsLetter = () => {
    return (
        <div className="flex flex-col items-center  max-w-5xl lg:w-full rounded-2xl px-4 py-12 md:py-16 mx-2 lg:mx-auto my-30 bg-gray-900 text-white">
            <Title align='center' title="Stay Inspired" subTitle="Stay updated with the latest travel deals, exclusive offers, and insider tips from QuickStay. Join our newsletter and be the first to know about exciting destinations and unforgettable experiences!" />
